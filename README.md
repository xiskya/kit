[README.md](https://github.com/user-attachments/files/30251206/README.md)
...
| 4 | **Un mensaje, tres versiones** | Adapta una noticia sensible a tres perfiles distintos y detecta qué cambia (lenguaje, canal, ritmo, ejemplos, explicación). | https://xiskya.github.io/mensajes/ |
| 5 | **Contrato para la comunicación** | Cierre: cada persona ordena diez compromisos, se queda con tres y genera su contrato personal para firmar. | https://xiskya.github.io/contrato/ |
...
5. **Contrato para la comunicación** — comprometerse con tres pasos concretos. El cierre.
...
- `qr-termometro`, `qr-confianza`, `qr-semaforo`, `qr-mensajes`, `qr-contrato` (`.png` y `.svg`) — QR de cada herramienta.
- `README.md` — este archivo.

Las herramientas en sí viven cada una en **su propio repositorio** (`termometro`, `generador`, `semaforo`, `mensajes`, `contrato`), con su propio README y sus opciones de personalización.
